...
namespace KitsuneGameplayTags
{
	...
	KITSUNE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Move);
	KITSUNE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Look);
	KITSUNE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Jump);
	KITSUNE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_ToggleMouseMode);
	KITSUNE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_LockOrSwitchTarget);
